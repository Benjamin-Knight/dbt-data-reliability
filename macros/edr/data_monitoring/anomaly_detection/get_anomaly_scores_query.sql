    ...
    {%- set anomaly_scores_query %}
        ...
        time_window_aggregation as (
            ...
            select
                ...
                {{ standard_deviation('metric_value') }} over (partition by metric_name, full_table_name, column_name, dimension, dimension_value, bucket_seasonality order by bucket_end asc rows between unbounded preceding and current row) as training_stddev,
